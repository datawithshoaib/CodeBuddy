...
**CodeBuddy** is an AI-powered coding assistant built with [LangGraph](https://github.com/langchain-ai/langgraph).
...
<div style="text-align: center;">
    <img src="images/coder_buddy_diagram.png" alt="Coder Agent Architecture" width="90%"/>
</div>
...
- Create a virtual environment using: `uv venv` and activate it using `source .venv/Scripts/activate`
- Install the dependencies using: `uv pip install -r requirements.txt`
